...
#line 125
  if ([o isKindOfClass:[GsonJsonObject class]]) {
    return JreLoadEnum(GsonJsonToken, BEGIN_OBJECT);
  }
  else
#line 127
  if ([o isKindOfClass:[GsonJsonArray class]]) {
    return JreLoadEnum(GsonJsonToken, BEGIN_ARRAY);
  }
  else
#line 129
  if ([o isKindOfClass:[GsonJsonPrimitive class]]) {
...
#line 140
  if ([o isKindOfClass:[GsonJsonNull class]]) {
    return JreLoadEnum(GsonJsonToken, NULL);
  }
  else
#line 142
  if (o == GsonJsonTreeReader_SENTINEL_CLOSED) {
...
- (NSString *)nextString {
  ...
  if (token != JreLoadEnum(GsonJsonToken, STRING) && token != JreLoadEnum(GsonJsonToken, NUMBER)) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$@$", @"Expected ", JreLoadEnum(GsonJsonToken, STRING), @" but was ",
#line 180
    token, GsonJsonTreeReader_locationString(self)));
  }
...
- (jdouble)nextDouble {
  ...
  if (token != JreLoadEnum(GsonJsonToken, NUMBER) && token != JreLoadEnum(GsonJsonToken, STRING)) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$@$", @"Expected ", JreLoadEnum(GsonJsonToken, NUMBER), @" but was ",
#line 210
    token, GsonJsonTreeReader_locationString(self)));
  }
...
#line 301
    if ([IOSObjectArray_Get(stack_JsonTreeReader_, i) isKindOfClass:[GsonJsonObject class]]) {
      if ([JavaUtilIterator_class_() isInstance:IOSObjectArray_Get(stack_JsonTreeReader_, ++i)]) {
...
void GsonJsonTreeReader_initWithGsonJsonElement_(GsonJsonTreeReader *self, GsonJsonElement *element) {
  ...
  self->stack_JsonTreeReader_ = [IOSObjectArray newArrayWithLength:
#line 51
  32 type:NSObject_class_()];
  self->stackSize_JsonTreeReader_ = 0;
  self->pathNames_JsonTreeReader_ = [IOSObjectArray newArrayWithLength:
#line 62
...
void GsonJsonTreeReader_expectWithGsonJsonToken_(GsonJsonTreeReader *self, GsonJsonToken *expected) {
  if ([self peek] != expected) {
    @throw new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$@$", @"Expected ",
#line 162
    expected, @" but was ", [self peek], GsonJsonTreeReader_locationString(self)));
  }
}
